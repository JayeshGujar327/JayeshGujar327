...
- 🔭 Building full-stack applications with **Java, Spring Boot, React and Node.js**
- 🌱 Learning **Advanced Java, Spring Boot, React, DSA, DBMS and AI**
- 🧠 Interested in **Software Engineering, AI-assisted applications and Interactive UI**
...
`AI-assisted Development` · `OCR` · `TensorFlow` · `Keras` · `OpenCV` · `Python` · `AI Integration` · `Data Processing`
...
|:---:|:---|
| ☕ **OOP** | Encapsulation · Inheritance · Polymorphism · Abstraction · Interfaces · Constructors · Exception Handling |
| 🧮 **DSA** | Arrays · Strings · Linked Lists · Stacks · Queues · Trees · Searching · Sorting · Recursion |
| 🗄️ **DBMS** | SQL · CRUD · Joins · Normalization · Transactions · ER Models · Database Design |
| 💻 **OS** | Processes · Threads · CPU Scheduling · Memory Management · Deadlocks · Synchronization |
...
**Highlights:** Personal branding · Interactive portfolio · Project showcase · Responsive interface · Animated UI · Technology showcase · Live deployment

---

# 🎤 GullyVerse — The Indian Hip-Hop Universe
...
**Highlights:** Artist-focused universe · Music-oriented experience · Dark visual identity · Interactive animations · Responsive interface · Interactive navigation
...
**Highlights:** Video-driven hero · Career statistics · Achievements · Sound interaction · Scroll reveals · Interactive game mode · Responsive design

---

# 🚀 Nexora — Modern Digital Experience
...
**Highlights:** Component-based UI · Responsive design · Interactive sections · Reusable components · User-focused experience

---

# 🎬 J CineVault — Movie & Entertainment Experience
...
**Highlights:** Movie discovery · Cinematic interface · Interactive sections · Responsive layout · Visual storytelling

---

# 💉 SmartCare — Smart Vaccination & Medicine Reminder System
...
`React → REST APIs → Spring Boot → Database → AI Services`
...
<details>
<summary><b>💼 Click to explore Job Portal</b></summary>
...
<details>
<summary><b>📋 Click to explore Collaborative Task Manager</b></summary>
...
`🗄️ DBMS` · `🌐 WEB` · `🤖 AI` · `☁️ DEPLOYMENT`

### Building stronger foundations by turning every concept into a working project.
